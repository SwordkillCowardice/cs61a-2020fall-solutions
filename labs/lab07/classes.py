...
class TACard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        """
        "*** YOUR CODE HERE ***"
        exchange = other_card.attack
        other_card.attack = other_card.defense
        other_card.defense = exchange
...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        opponent.deck.cards = [x for x in copy if x.attack != other_card.attack and x.defense != other_card.defense]
