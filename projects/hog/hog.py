...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        if who == 0 and score0 - last_score > running_high:
            print(str(score0 - last_score) + " point(s)! The most yet for Player 0")
            ...
            print(str(score1 - last_score ) + " point(s)! The most yet for Player 1")
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    ave_func = make_averaged(roll_dice, trials_count)
    max_value = ave_func(1, dice)
    ans, i = 1, 2
    while i <= 10:
        result = ave_func(i, dice)
        if result > max_value:
            max_value = result
            ans = i
        i += 1
